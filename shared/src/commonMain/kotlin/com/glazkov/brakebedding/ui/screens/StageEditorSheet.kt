...
import com.glazkov.brakebedding.platform.fixedDecimal
 ...
 *
 * The format uses a dot separator, independent of the locale. This value goes into an
...
private fun Double.round(decimals: Int = 0): String {
    val text = fixedDecimal(this, decimals)
